...
// .wrangler/tmp/bundle-Ehg5IB/checked-fetch.js
...
// .wrangler/tmp/bundle-Ehg5IB/strip-cf-connecting-ip-header.js
...
async function getRandomItem(db, competitionBoost = false) {
  ...
  const adjustedItems = items.map((item) => ({
    ...item,
    rate: competitionBoost ? getCompetitionBoostRate(item.id, item.rate) : item.rate
  }));
...
// .wrangler/tmp/bundle-Ehg5IB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ehg5IB/middleware-loader.entry.ts
